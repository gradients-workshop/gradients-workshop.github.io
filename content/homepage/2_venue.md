...
The image above is an example room in the château, though each room has its own unique personality. Indoor beds are available in four different buildings distributed around the center of the property. <ins>Please note that the majority of the rooms will have more than one bed, and that the 'bed in indoor rooms' registration is for one bed in a room shared with other beds.</ins> If there are specific attendees that you would like to share a room with during the stay, please indicate when registering and we will do our very best to accommodate.  
